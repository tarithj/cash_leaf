...
enum TransactionMenuItems { delete, edit }
...
class Transaction extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var creationDateDifference =
        DateTime.now().difference(record.getCreatedDateTime());
    ...
    return Card(
      child: ListTile(
              ...
              builder: (context) {
                return TransactionModalBottomSheet(
                  ...
                  onEditPressed: () {
                    ...
                    onSelectOption(TransactionMenuItems.edit);
                  },
                  onDeletePressed: () {
                    Navigator.pop(context);
                    onSelectOption(TransactionMenuItems.delete);
                  },
                );
              });
        },
        ...
        subtitle: Text(
            timeago.format(DateTime.now().subtract(creationDateDifference))),
        trailing: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text(
              "${record.amount.toString()} $currencySymbol",
